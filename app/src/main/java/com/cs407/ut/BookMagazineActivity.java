...
public class BookMagazineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cat_bookmag);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    Log.d("BookMagazineActivity", "Item Category: " + dataClass.getItemCategory());
                    if ("Books and Magazines".equals(dataClass.getItemCategory())) {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BookMagazineActivity.this, "Error fetching data", Toast.LENGTH_SHORT).show();
            }
        });
