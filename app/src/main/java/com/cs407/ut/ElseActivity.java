...
public class ElseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cat_else);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    Log.d("ElseActivity", "Item Category: " + dataClass.getItemCategory());
                    if ("Everything else".equals(dataClass.getItemCategory())) {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ElseActivity.this, "Error fetching data", Toast.LENGTH_SHORT).show();
            }
        });
