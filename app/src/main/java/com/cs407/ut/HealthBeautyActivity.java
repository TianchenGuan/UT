...
public class HealthBeautyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cat_healthbeauty);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    Log.d("HealthBeautyActivity", "Item Category: " + dataClass.getItemCategory());
                    if ("Health and Beauty".equals(dataClass.getItemCategory())) {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(HealthBeautyActivity.this, "Error fetching data", Toast.LENGTH_SHORT).show();
            }
        });
