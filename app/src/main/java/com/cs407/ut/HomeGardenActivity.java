...
public class HomeGardenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cat_homegarden);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    Log.d("HomeGardenActivity", "Item Category: " + dataClass.getItemCategory());
                    if ("Home and Garden".equals(dataClass.getItemCategory())) {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(HomeGardenActivity.this, "Error fetching data", Toast.LENGTH_SHORT).show();
            }
        });
